...
ここでは，初期速度は $(0.035，0.000)$[m/s]，加速度は $(0.004，0.000)$[m/s$^2$]に設定した．
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene1/suggestion-v2.png}
    \caption{提案手法}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene1/enokida-v2.png}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene1/potential-v2.png}
...
センサベースのポテンシャル法と比較しても，到達時間が7[s]，経路長が0.84[m]とそれぞれ改善されている．
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene2/suggestion-v2.png}
    \caption{提案手法}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene2/enokida-v2.png}
    \caption{従来研究\cite{enokida}}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene2/potential-v2.png}
    \caption{センサベースのポテンシャル法}
...
センサベースのポテンシャル法に対しても，到達時間が9[s]，経路長は1.08[m]の改善を示した．
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene3/suggestion-v2.png}
    \caption{提案手法}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene3/enokida-v2.png}
    \caption{従来研究\cite{enokida}}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene3/potential-v2.png}
    \caption{センサベースのポテンシャル法}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene4/suggestion-v2.png}
    \caption{提案手法}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene4/enokida-v2.png}
    \caption{従来研究\cite{enokida}}
  ...
  \begin{subfigure}[b]{0.85\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene4/potential-v2.png}
    \caption{センサベースのポテンシャル法}
...
図\ref{fig:scene4}(\subref{fig:scene4/potential})のセンサベースのポテンシャル法は静的障害物である壁の影響により停留し到達不能となった．
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene5/suggestion-v2.png}
    \caption{提案手法}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene5/enokida-v2.png}
    \caption{従来研究\cite{enokida}}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figure/scene5/potential-v2.png}
    \caption{センサベースのポテンシャル法}
