...
具体的には，図\ref{fig:scene2}(\subref{fig:scene2/enokida})の従来研究\cite{enokida}による回避軌道は障害物から大きく迂回し，冗長な経路となっている．
また図\ref{fig:scene2}(\subref{fig:scene2/potential})に示している通常のポテンシャル法も障害物の進行方向前方へ進入しようとする挙動が見られる．
...
図\ref{fig:scene5}(\subref{fig:scene5/enokida})の従来研究\cite{enokida}では，障害物に対しての十分な安全距離を保ちスムーズに回避している．
...
図\ref{fig:scene5}(\subref{fig:scene5/suggestion})の提案手法では等速運動のような単純な動的環境においても障害物を回避し目的地へ到達している．
