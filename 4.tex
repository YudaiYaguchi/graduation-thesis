\newpage
\section{シミュレーション}
加速度推定機能を組み込んだ提案手法，従来研究\cite{enokida}の速度推定機能を用いた手法，およびセンサ情報のみを利用したポテンシャル法の3つの手法についてシミュレーションを実施し，それぞれの性能を比較評価する．
シミュレーションでは，動的障害物として縦・横2[m]の大きさを有する障害物を設定した．
また，ロボットの初期位置は青色の円，目標位置は赤色の円，ロボットの軌跡を青の実線で示す．

\subsection{シミュレーション結果}
5つの異なる場面におけるシミュレーション結果を示す．
各場面について，提案手法，従来研究\cite{enokida}，およびセンサ付きポテンシャル法の3手法の性能を比較する．
...
\hline
センサ付きポテンシャル法 & 120 & 14.40 \\
\hline
\end{tabular}
\end{table}


提案手法は到達時間が113ステップ，経路長が13.56[m]となり，従来研究\cite{enokida}と比較して到達時間が31ステップ短縮され，経路長も3.72[m]短くなった．
センサ付きポテンシャル法と比較しても，到達時間が7ステップ，経路長が0.84[m]それぞれ改善されている．
...
本場面では，障害物の初期速度は$(-0.035, -0.035)$[m/step]，加速度は$(-0.0030, -0.0015)$[m/step$^2$]に設定した．
...
\hline
センサ付きポテンシャル法 & 115 & 13.80 \\
\hline
\end{tabular}
\end{table}

提案手法は到達時間が106ステップ，経路長が12.72[m]となり，従来研究\cite{enokida}と比較して到達時間が33ステップ短縮され，経路長も3.96[m]短くなった．
センサ付きポテンシャル法と比較しても，到達時間が9ステップ，経路長が1.08[m]それぞれ改善されている．
...
\hline
センサ付きポテンシャル法 & 121 & 14.52 \\
\hline
\end{tabular}
\end{table}

提案手法は到達時間が110ステップ，経路長が13.20[m]となり，従来研究\cite{enokida}と比較して到達時間が26ステップ短縮され，経路長も3.12[m]短くなった．
センサ付きポテンシャル法と比較しても，到達時間が11ステップ，経路長が1.32[m]それぞれ改善されている．
...
提案手法は到達時間が145ステップ，経路長が17.40[m]となり，従来研究\cite{enokida}と比較して到達時間が26ステップ短縮され，経路長も3.12[m]短くなった．
一方，センサ付きポテンシャル法では目的地への到達が不可能であった．
...
\hline
センサ付きポテンシャル法 & 159 & 19.08 \\
\hline
\end{tabular}
\end{table}

提案手法は到達時間が122ステップ，経路長が14.64[m]となり，従来研究\cite{enokida}と比較して到達時間が11ステップ短縮され，経路長も1.32[m]短くなった．
センサ付きポテンシャル法と比較しても，到達時間が37ステップ，経路長が4.44[m]それぞれ改善されている．

\subsection{考察}
5つの場面におけるシミュレーション結果を総合すると，提案手法は全ての場面において，従来研究\cite{enokida}およびセンサ付きポテンシャル法と比較して，より短い到達時間と経路長を実現した．
...
また，図\ref{fig:scene4}のように動的障害物と静的障害物である壁が同時に存在する複雑な環境下において，センサ付きポテンシャル法が目的地への到達に失敗したのに対し，提案手法および従来研究\cite{enokida}はいずれも目的地への到達に成功した．
